...
public class SessionLogger {
	...
	public static void main(String[] args) throws Exception{
		...
		SessionLogger info = new SessionLogger();
		...
		info.chatCount = 0;												//initialize session count
		...
		while(exitProg != "yes") {
			...
			//TODO add extra else if case for when the user wants to return chat data
	...
	public void writeChatSessionFile(BufferedWriter aWriter, List<String> aInput, List<String> aResponse) throws Exception{
		...
		for(int i = 0; i<aInput.size(); i++) {
				aWriter.write("User Query: "+aInput.get(i)+"\n");
				aWriter.write("System Response: "+aResponse.get(i)+"\n");
		}
	...
	public void writeChatStatsFile(BufferedWriter bWriter, long time, String aDate, String aTime, int userUt, int sysUt) throws Exception{
		//TODO somehow add session number 
